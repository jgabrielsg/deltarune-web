    ...
    onMount(() => {
        if (typeof window !== 'undefined') {
            ...
            game.setObstacles([
                ...
                new Obstacle(windowWidth/2 - 384, 128, 96, 96, `${base}/images/spr_note_poster.png`, 'noteposter'),
                new Obstacle(windowWidth/2 + 256, 128, 96, 96, `${base}/images/spr_kris_poster.png`, 'krisposter'),

                new Obstacle(windowWidth/2 - 256, 128, 96, 96, `${base}/images/spr_right_arrow.png`, 'rightarrow'),
                new Obstacle(windowWidth/2 + 128, 128, 96, 96, `${base}/images/spr_left_arrow.png`, 'leftarrow'),
            ]);
