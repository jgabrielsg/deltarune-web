    ...
    onMount(() => {
        if (typeof window !== 'undefined') {
            ...
            game.setObstacles([
                ...
                new Obstacle(windowWidth/2      -60, windowHeight / 2 - 20, 120, 80, `${base}/images/spr_classdesk(0).png`),
                new Obstacle(windowWidth/2 - 256-60, 128, 120, 80, `${base}/images/spr_sign.png`),
                new Obstacle(windowWidth/2      -60, 128, 120, 80, `${base}/images/spr_sign.png`),
                new Obstacle(windowWidth/2 + 256-60, 128, 120, 80, `${base}/images/spr_sign.png`),
            ]);
